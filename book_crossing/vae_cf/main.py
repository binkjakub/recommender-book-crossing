...
parser.add_argument('--data', type=str, default='../book-crossing',
...
def evaluate(data_tr, data_te):
    ...
    return total_loss, np.nanmean(n10_list), np.nanmean(r10_list), np.nanmean(r50_list)
...
try:
    for epoch in range(1, args.epochs + 1):
        ...
        train()
        val_loss, n10, r10, r50 = evaluate(vad_data_tr, vad_data_te)
        print('-' * 89)
        print('| end of epoch {:3d} | time: {:4.2f}s | valid loss {:4.2f} | '
              'n10 {:5.3f} | r10 {:5.3f} | r50 {:5.3f}'.format(
        ...
        writer.add_scalar('data/r10', r10, n_iter)
...
# Run on test data.
test_loss, n10, r10, r50 = evaluate(test_data_tr, test_data_te)
print('=' * 89)
print('| End of training | test loss {:4.2f} | n10 {:4.2f} | r10 {:4.2f} | '
      'r50 {:4.2f}'.format(test_loss, n10, r10, r50))
print('=' * 89)